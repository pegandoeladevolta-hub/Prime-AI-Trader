...
- Sinal de três classes, pré-sinal, confirmação no fechamento e três sensibilidades.
- Notícias GDELT e classificação local de risco/sentimento; calendário Finnhub para Forex quando a chave permite o endpoint.
- Radar de mercado, backtest fora da amostra, matriz de confusão, cobertura e desempenho por hora.
